...
class RemoveFromCartUseCase @Inject constructor(private val repository: HomeRepository) :
        (Food) -> Single<List<Food>> {

    override fun invoke(item: Food) : Single<List<Food>> = repository.removeFromCart(item)
